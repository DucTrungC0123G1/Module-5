            ...
            >
                <div className="container">
                    ...
                    <Form>
                        ...
                        <div>
                            <h4><b>Trong vòng 14 ngày qua, Anh/Chị có đến quốc gia/ vùng lãnh thổ nào(Có thể đi nhiều quốc
                                gia)</b></h4>
                        </div>
                        <div className="col-sm-3 my-1">
                        ...
                        <div className="col-sm-3 my-1">
                            <Field type="checkbox" name="meet" value="1" className="form-group mb-3"/>Người bệnh hoặc nghi
                            ngờ,
                            mắc bện COVID
                        </div>
                        <div className="col-sm-3 my-1">
                            <Field type="checkbox" name="meet" value="8" className="form-group mb-3"/>Người từ nước có bệnh
                            COVID
                        </div>
                        <div className="col-sm-3 my-1">
